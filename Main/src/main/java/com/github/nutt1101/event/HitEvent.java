...
public class HitEvent implements Listener {
    ...
    public String getIsCustomEntity(Entity hitEntity) {
        ...
        switch (CatchBall.getServerVersion()) {
            case "1.21.2-R0.1-SNAPSHOT", "1.21.3-R0.1-SNAPSHOT" -> checkCustom = NBT_v1_21_2.isCustomEntity(hitEntity);
            case "1.21-R0.1-SNAPSHOT", "1.21.1-R0.1-SNAPSHOT" -> checkCustom = NBT_v1_21.isCustomEntity(hitEntity);
            case "1.20.5-R0.1-SNAPSHOT", "1.20.6-R0.1-SNAPSHOT" -> checkCustom = NBT_v1_20_5.isCustomEntity(hitEntity);
